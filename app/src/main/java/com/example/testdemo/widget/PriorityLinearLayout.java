 ...
 * @author okg
 * @date 2021/7/5
 * @description 参考腾讯QMUI控件，可以根据优先级设置决定不同位置元素的压缩展示情况
 */
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            final TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.PriorityLinearLayout_Layout);
            priority = a.getInteger(R.styleable.PriorityLinearLayout_Layout_layout_priority,
                    PRIORITY_MINI_CONTENT_PROTECTION);
            miniContentProtectionSize = a.getDimensionPixelSize(
                    R.styleable.PriorityLinearLayout_Layout_layout_miniContentProtectionSize,
                    0);
            a.recycle();
        }

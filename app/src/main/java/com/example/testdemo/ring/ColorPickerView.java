...
public class ColorPickerView extends View {
     ...
     * 指示点内圈的画笔
     */
    private Paint paintForIndicatorInnerCircle;
...

    {
        ...
        paintForIndicatorInnerCircle = new Paint();
        paintForIndicatorInnerCircle.setAntiAlias(true);
        paintForIndicatorInnerCircle.setStyle(Paint.Style.FILL);
...
//    }
    ...
    private void createIndicatorBitmap() {
        ...
        paintForIndicatorInnerCircle.setColor(mIndicatorColor);
        c.drawCircle(mRadius, mRadius, mRadius / 2, paintForIndicatorInnerCircle);
